...
export async function generateMetadata({ params }) {
  ...
  if (CATEGORIES.includes(slug)) {
    ...
    return {
      title: `EricaStream - ${title} Movies`,
      description: `Explore the ${title} movies collection on EricaStream.`,
    };
  }
  ...
  if (genreMatch) {
    ...
    return {
      title: `EricaStream - ${genreName} Movies`,
      description: `Discover ${genreName} movies on EricaStream.`,
    };
  }
