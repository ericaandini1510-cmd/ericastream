...
export async function generateMetadata({ params }) {
  ...
  const pageUrl = `https://ericastream.netlify.app/tv-show/genre/${genreName}`;
  const imageUrl = 'https://live.staticflickr.com/65535/55089277311_67f6a8faba_b.jpg';

  return {
    title: `EricaStream - ${title} TV Series`,
    description: `Find and watch the best ${title} TV series for free on EricaStream.`,
    openGraph: {
      title: `EricaStream - ${title} TV Series`,
      description: `Find and watch the best ${title} TV series for free on EricaStream.`,
      url: pageUrl,
